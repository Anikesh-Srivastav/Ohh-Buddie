...
// moved outside so it's not recreated on every render
const taglines = [
...
const Loader = () => {
    ...
    ScrollTrigger.create({
      ...
      onUpdate: (self) => {
        ...
        if (progress <= 7 / 8) {
          ...
          const newHeight = gsap.utils.interpolate(52.75, 100, animationProgess);
  ...
  return (
    <ReactLenis root options={{ lerp: 0.1, duration: 1.5, syncTouch: true }}>
      <div className="container" ref={containerRef} style={{ minHeight: '800vh' }}>
